...
RUN \
  ...
  $CKAN_HOME/bin/pip install -e git+https://github.com/mxabierto/ckanext-dcat@develop#egg=ckanext-dcat && \
  ...
  #$CKAN_HOME/bin/pip install -e git+https://github.com/mxabierto/CKAN_Calidad.git#egg=ckanext-mxopeness&subdirectory=ckanext-mxopeness && \
